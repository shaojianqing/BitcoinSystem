...
public class TestRawTransaction {
    ...
    public void validate() throws Exception {
        ...
        if (scriptProgram1.isP2PKH()) {
            ...
            Assert.assertEquals("formatted address!", originLegacyAddress1, legacyAddress1.stringFormat());

            Logger.info("The pubKey1 is:%s", originPubKeyStr1);
            Logger.info("The formatted address1:%s", legacyAddress1.stringFormat());
        }
        ...
        if (scriptProgram2.isP2PKH()) {
            ...
            Assert.assertEquals("formatted address!", originLegacyAddress2, legacyAddress2.stringFormat());

            Logger.info("The pubKey2 is:%s", originPubKeyStr2);
            Logger.info("The formatted address2:%s", legacyAddress2.stringFormat());
        }
